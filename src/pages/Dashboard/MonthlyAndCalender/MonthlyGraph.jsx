...
const MonthlyGraph = () => {
  ...
  const graphTitle={color:`${lightTheme.lightDarkBlue}`,fontWeight:'500',fontSize:'16px'}
  const graphTitleB={color:`${lightTheme.textColor}`,fontWeight:'500',fontSize:'16px'}

  return (
    <div className="monthlyGrpahMain" style={{backgroundColor:`${lightTheme.ComponentBackgroundColor}`}}>
      <div className="dailyAndMonthlyDiv">
        <p className="dailyM" style={graphTitle}>Daily</p>
        <Divider orientation="vertical" flexItem/>
        <p className="monthlyM" style={graphTitleB}>Monthly</p>
          </div>
