      ...
      <Box sx={mainDiv}>
        <Grid container columnGap={4} rowGap={4} my={3}>
          <Grid item lg={5.5} md={12} sm={12} sx={gridItem}>
            <p style={graphTitle}>Trade Distribution By SPY Movement</p>
            <Chart
          ...
          <Grid item lg={5.5} md={12} sm={12} sx={gridItem}>
            <p style={graphTitle}>Performance By SPY Movement</p>
            <Chart
        ...
        <Grid container columnGap={4} rowGap={4} my={3}>
          <Grid item lg={5.5} md={12} sm={12} sx={gridItem}>
            <p style={graphTitle}>Trade Distribution By SPY Opening Gap</p>
            <Chart
          ...
          <Grid item lg={5.5} md={12} sm={12} sx={gridItem}>
            <p style={graphTitle}>Performance By SPY Opening Gap</p>
            <Chart
        ...
        <Grid container columnGap={4} rowGap={4} my={3}>
          <Grid item lg={5.5} md={12} sm={12} sx={gridItem}>
            <p style={graphTitle}>Trade Distribution By SPY Day Type</p>
            <Chart
          ...
          <Grid item lg={5.5} md={12} sm={12} sx={gridItem}>
            <p style={graphTitle}>Performance By SPY Day Type</p>
            <Chart
