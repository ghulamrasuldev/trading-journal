          ...
          <Grid container className="grid" columnGap={10}>
            ...
            <Grid item lg={4} md={6} sm={6}>
              <div className="formDiv">
                ...
                <div className="google" onClick={()=>console.log('login With Google')}>
                  <img src={GoogleIcon} alt="google Icon" className='googleIcon'/>
                  <p className='loginWithGoogle' style={{color:`${lightTheme.headingColor}`}}>Login with google</p>
                </div>
                ...
                <div className="mailDiv">
                  <img src={MailIcon} alt="Mail Icon" className='mailIcon' style={{color:`${lightTheme.iconColor}`}}/>
                ...
                <div className="passwordDiv">
                  ...
                  <img src={passwordIcon}  alt="password Icon" className="passwordIcon" style={{color:`${lightTheme.iconColor}`}}/>
                ...
                <div className="checkBox">
                  ...
                  <label For="remember" className="checkboxLabel" style={{color:`${lightTheme.headingColor}`}}>Remember me</label>
                </div>
                <div className="loginBtnDiv">
                  <button className="loginBtn" onClick={()=>LoginInFunc()} style={{backgroundColor:`${lightTheme.headingTextColor}`,color:`${lightTheme.whiteText}`}}>Login</button>
                </div>
                <p className="noAccount" style={{color:`${lightTheme.headingColor}`}}>Don't have an account!<span className="register" onClick={()=>goToSignUp()} style={{color:`${lightTheme.headingTextColor}`}}>Register</span></p>
                </div>
            </Grid>
          </Grid>
        </div>
