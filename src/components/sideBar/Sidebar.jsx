...
const Sidebar = ({ children }) => {
  ...
  return (
    <div className="container">
      <div
        className="sidebar"
        style={{ width: isOpen ? '250px' : '70px', backgroundColor: lightTheme.ComponentBackgroundColor }}
      >
        ...
        <div className="topSection">
          <div className="logoSection">
            ...
            <p className="name" style={{ display: isOpen ? 'block' : 'none', color: lightTheme.textColor }}>
              Journal Trade
            </p>
          </div>
          ...
          {menuItem.map((item, index) => {
            return (
              ...
              >
                ...
                <div className="link_text" style={{ display: isOpen ? 'block' : 'none', color: lightTheme.textColor }}>
                  {item.name}
                </div>
              </NavLink>
            );
