...
import Profile from "../pages/JournalSetting/Profile/Profile";
    ...
    <Router>
      <Sidebar>
        <Routes>
          ...
          <Route
            path="/journalSetting/privacy"
            element={<PrivacyAndPublicProfile />}
          />
          <Route path="/journalSetting/profile" element={<Profile />} />
          <Route
            path="/journalSetting/tradesetting"
            element={<TradeSetting />}
          />
          <Route path="/login" element={<Login />} />
          <Route path="/signup" element={<SingUp />} />
          <Route
            path="/performance/compare/daysandtimes"
            element={<DaysAndTimesC />}
          />
          <Route
            path="/performance/compare/instrument"
            element={<InstrumentC />}
          />
          <Route
            path="/performance/compare/liquidity"
            element={<LiquidityC />}
          />
          <Route
            path="/performance/compare/marketbahviour"
            element={<MarketBehaviourC />}
          />
          <Route
            path="/performance/compare/pricevolume"
            element={<PriceVolumeC />}
          />
          <Route
            path="/performance/compare/winlossexpectation"
            element={<WinLossExpectationC />}
          />
          <Route
            path="/performance/detail/daysandtimes"
            element={<DaysAndTimesD />}
          />
          <Route
            path="/performance/detail/instrument"
            element={<InstrumentD />}
          />
          <Route
            path="/performance/detail/liquidity"
            element={<LiquidityD />}
          />
          <Route
            path="/performance/detail/marketbahviour"
            element={<MarketBehaviourD />}
          />
          <Route
            path="/performance/detail/pricevolume"
            element={<PriceVolumeD />}
          />
          <Route
            path="/performance/detail/winlossexpectation"
          ...
          <Route
            path="/performance/overview/report"
            element={<OverViewReport />}
          />
          <Route path="/performance/tagbreakdown" element={<TagBreakDown />} />
          <Route
            path="/performance/winvslossday/daysandtimes"
            element={<DaysAndTimesWLD />}
          />
          <Route
            path="/performance/winvslossday/instrument"
            element={<InstrumentWLD />}
          />
          <Route
            path="/performance/winvslossday/liquidity"
            element={<LiquidityWLD />}
          />
          <Route
            path="/performance/winvslossday/marketbahviour"
            element={<MarketBehaviourWLD />}
          />
          <Route
            path="/performance/winvslossday/pricevolume"
            element={<PriceVolumeWLD />}
          />
          <Route
            path="/performance/winvslossday/winlossexpectation"
